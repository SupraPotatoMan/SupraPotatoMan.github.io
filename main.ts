...
let Skeller: Sprite = null

//Plot and Opening Background
scene.setBackgroundImage(img`
    ...
    `)
game.splash("Calcium Quest")
game.splash("Press A To Start")
game.splash("Ever since cows went extinct Skeller The Skeleton has wandered bone land in search of the Magic Milk.")
game.splash("The only clue to it's location? The Cow Crypt.")
//Adds the Player Sprites, and movement as well as tilemap
tiles.setCurrentTilemap(tilemap`ForestLevel`)
Skeller = sprites.create(img`
. . . . . . . . . . . . . . . . 
. . . . . . . . . . . . . . . . 
. . . . . c c c c c . . . . . . 
. . . . c 1 1 1 1 1 . . . . . . 
...
. . . . . . . . . . . . . . . . 
`, SpriteKind.Player)
scene.cameraFollowSprite(Skeller)
Skeller.setStayInScreen(false)
Skeller.setPosition(10, 50)
info.player1.setScore(0)
controller.moveSprite(Skeller)
Baddie = sprites.create(assets.image`Baddies`, SpriteKind.Enemy)
controller.player1.onButtonEvent(3, ControllerButtonEvent.Pressed, function () {

    Skeller.setImage(assets.image`Skeller Move`)
})
controller.player1.onButtonEvent(1, ControllerButtonEvent.Pressed, function () {

    Skeller.setImage(assets.image`Skeller Move Back`)
})
controller.player1.onButtonEvent(2, ControllerButtonEvent.Pressed, function () {


    Skeller.setImage(assets.image`Skeller Move`)
})
controller.player1.onButtonEvent(4, ControllerButtonEvent.Pressed, function () {


    Skeller.setImage(assets.image`Skeller Move`)
})
controller.player1.onButtonEvent(3, ControllerButtonEvent.Released, function () {
...
controller.player1.onButtonEvent(1, ControllerButtonEvent.Released, function () {
...
controller.player1.onButtonEvent(2, ControllerButtonEvent.Released, function () {
...
controller.player1.onButtonEvent(4, ControllerButtonEvent.Released, function () {
